...
const SupplierBillingTest = () => {
  ...
  // Add state to prevent multiple loads
  ...
  const handleCreateSupplier = async () => {
    try {
      ...
      // Refresh summary with delay to prevent re-render loop
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-3xl font-bold">ทดสอบระบบ Supplier Billing</h1>
          <p className="text-muted-foreground">
            ทดสอบการสร้างซัพพลายเออร์และใบแจ้งหนี้
          </p>
        </div>
      </div>
...
export default SupplierBillingTest;