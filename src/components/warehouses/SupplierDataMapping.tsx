...
export function SupplierDataMapping({ supplierId, onMappingCreated, onMappingTested }: SupplierDataMappingProps) {
  ...
  const mockMappings: DataMapping[] = [
    {
      ...
      description: 'แมปข้อมูลสินค้าจาก Supplier API เข้าสู่ระบบ',
      category: 'products',
      sourceSchema: {
        name: 'Furniture Thai API Schema',
        version: '1.2',
        fields: [
          {
            name: 'product_id',
            type: 'string',
            description: 'รหัสสินค้าของ Supplier',
            required: true,
            example: 'FT-SF-001'
          },
          {
            ...
            required: true,
            example: 'โซฟา 3 ที่นั่ง สีน้ำตาล'
          },
          {
            name: 'category_code',
            type: 'string',
          ...
          },
          {
            name: 'serial_numbers',
            type: 'array',
            description: 'รายการ Serial Number',
            required: true,
            example: ['SF001-001', 'SF001-002']
          }
        ]
      },
      targetSchema: {
        name: 'Flexi Furnish System Schema',
        version: '2.0',
        fields: [
          {
            name: 'sku',
            type: 'string',
            description: 'รหัสสินค้าในระบบ',
            required: true,
            example: 'SF-001'
          },
          {
      ...
      mappingRules: [
        {
          ...
          targetField: 'sku',
          transformation: 'removePrefix("FT-")',
          priority: 1,
          isActive: true
        },
        {
        ...
        {
          id: 'rule-005',
          sourceField: 'serial_numbers',
          targetField: 'serialNumbers',
          priority: 5,
          isActive: true
        }
      ],
      transformations: [
        {
          ...
          name: 'Remove Prefix',
          type: 'format',
          description: 'ลบ prefix "FT-" ออกจากรหัสสินค้า',
          inputFields: ['product_id'],
          outputField: 'sku',
          logic: 'value.replace(/^FT-/, "")',
          isActive: true
        },
        {
          id: 'transform-002',
          ...
          type: 'lookup',
          description: 'แปลงรหัสหมวดหมู่เป็นชื่อหมวดหมู่',
          inputFields: ['category_code'],
          outputField: 'category',
          logic: 'categoryMap[value] || "other"',
          parameters: {
            categoryMap: {
              'SOFA': 'furniture',
              'TABLE': 'furniture',
        ...
        rules: [
          {
            ...
            field: 'sku',
            type: 'required',
            description: 'SKU ต้องไม่เป็นค่าว่าง',
    ...
    },
    {
      ...
      name: 'Inventory Data Mapping',
      description: 'แมปข้อมูลสินค้าคงคลังจาก CSV file',
      category: 'inventory',
      sourceSchema: {
        name: 'Electronics Plus CSV Schema',
        version: '1.0',
        fields: [
          {
            name: 'SKU',
  ...
  // Mock mapping tests
  const mockMappingTests: MappingTest[] = [
    {
      id: 'test-001',
      mappingId: 'mapping-001',
      testName: 'Product Mapping Test',
      sampleData: {
        product_id: 'FT-SF-001',
        product_name: 'โซฟา 3 ที่นั่ง สีน้ำตาล',
        category_code: 'SOFA',
        price_baht: 25000,
        serial_numbers: ['SF001-001', 'SF001-002']
      },
      expectedOutput: {
        sku: 'SF-001',
        ...
        category: 'furniture',
        price: 25000,
        serialNumbers: ['SF001-001', 'SF001-002']
      },
      actualOutput: {
        sku: 'SF-001',
        name: 'โซฟา 3 ที่นั่ง สีน้ำตาล',
    ...
    },
    {
      ...
      testName: 'Inventory Mapping Test',
      sampleData: {
        SKU: 'TV-001',
        QTY: 25,
        STATUS: 'AVAILABLE'
  ...
  useEffect(() => {
    setMappings(supplierId ? mockMappings.filter(m => m.supplierId === supplierId) : mockMappings);
    setMappingTests(mockMappingTests);
  }, [supplierId]);
